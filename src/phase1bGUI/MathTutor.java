...
public class MathTutor extends JFrame {
	...
	public MathTutor() {
		...
		ImageIcon printerIcon = new ImageIcon("Images/printer.png");
	...
	public void buildLoginFrame() {
		...
		*/
		...
		URL imageURL = this.getClass().getClassLoader().getResource("Images/logo.jpg");
		...
		*/
		...
		/*
		* Adds the logo, login panel, and buttons panel to the login internal frame
		*/
